...
@implementation SLIViewController
...
- (void)viewDidLoad
{
	[self embedYouTube:@"http://www.youtube.com/watch?v=t4TD9JgWTFs&feature=channel_page" frame:webView.frame];

	self.title = @"Structured Light";
	...
	for (i = 1; i <= 5; i++)
	{
		NSString *imageName = [NSString stringWithFormat:@"sli%d.jpg", i];
