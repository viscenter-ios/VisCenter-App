...
- (void)viewDidLoad
{
	[self embedYouTube:@"http://www.youtube.com/watch?v=-EvpQ-taUMI" frame:webView.frame];
	...
	for (i = 1; i <= 5; i++)
	{
		NSString *imageName = [NSString stringWithFormat:@"spain%d.jpg", i];
