...
@implementation EDUCEViewController
...
- (void)viewDidLoad
{
	[self embedYouTube:@"http://www.youtube.com/watch?v=wQ8v69wJ3K4&feature=channel_page" frame:webView.frame];
	...
	for (i = 1; i <= 5; i++)
	{
		NSString *imageName = [NSString stringWithFormat:@"educe%d.jpg", i];
