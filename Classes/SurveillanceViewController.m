...
@implementation SurveillanceViewController
...
- (void)viewDidLoad
{
	[self embedYouTube:@"http://www.youtube.com/watch?v=qb4ryI9ng6o&feature=channel_page" frame:webView.frame];
	...
	for (i = 1; i <= 5; i++)
	{
		NSString *imageName = [NSString stringWithFormat:@"surveillance%d.jpg", i];
