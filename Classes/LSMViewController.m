...
- (void)viewDidLoad
{
	//[self embedYouTube:@"" frame:webView.frame];

	self.title = @"Liquid Modeling";
	...
	for (i = 1; i <= 5; i++)
	{
		NSString *imageName = [NSString stringWithFormat:@"lsm%d.jpg", i];
